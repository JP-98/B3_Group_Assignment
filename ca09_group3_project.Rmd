...
```{r}
model7 <- lm(lnprice_4_nights ~ prop_type_simplified+neighbourhood_simplified+review_scores_rating+accommodates+host_is_superhost+availability_30, data = vienna_train)
msummary(model7)
car::vif(model7)
autoplot(model7) +
  theme_minimal() + 
