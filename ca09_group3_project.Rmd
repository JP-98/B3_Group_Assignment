...
We then conduct a thorough EDA. Recall that an EDA involves three things:
...
```
There are 37 numeric variables, 9 logical, 5 date and 3 character variables. 
...
Accoridng to our hypothesis, the following variables will potentially affect the price. 
...
Then, we plot the distribution of pirce. As the distribution is significantly right skewed, we therefore use log function to restructure the price data.
